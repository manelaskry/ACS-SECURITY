...
const Navbar = () => {
  ...
  return (
    ...
    <div className="container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent">
        ...
        <ul className='hidden md:flex gap-6 lg:gap-11 text-white text-sm lg:text-base'>
            <a href="#Header" className='cursor-pointer hover:text-gray-400 whitespace-nowrap'>Sécurité</a>
            <a href="#Header" className='cursor-pointer hover:text-gray-400 whitespace-nowrap'>Formations</a>
            <a href="#Header" className='cursor-pointer hover:text-gray-400 whitespace-nowrap'>Références</a>
            <a href="#Header" className='cursor-pointer hover:text-gray-400 whitespace-nowrap'>Audit</a>
        </ul>

        <button className='hidden md:block bg-white px-6 lg:px-8 py-2 rounded-full text-sm lg:text-base whitespace-nowrap'>Contact</button>
    ...
    <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'} right-0 top-0 bottom-0 overflow-hidden bg-white transition-all z-50`}>
        <div className='flex justify-end p-6 cursor-pointer'>
            <FaTimes onClick={()=> setShowMobileMenu(false)} className='text-black text-3xl cursor-pointer'/>   
        </div>
